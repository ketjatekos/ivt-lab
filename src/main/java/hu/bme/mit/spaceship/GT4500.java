    ...
    switch (firingMode) {
      case SINGLE:
        if (wasPrimaryFiredLast) {
	        firingSuccess = fireTorpedoFromStore(secondaryTorpedoStore, primaryTorpedoStore, false);
        }
        else {
	        firingSuccess = fireTorpedoFromStore(primaryTorpedoStore, secondaryTorpedoStore, true);
        }
        break;
